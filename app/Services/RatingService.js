...
module.exports = {
    create: (data, callback) => {
        let _query = `INSERT INTO rating( code, description, SID, fid, sy_id, class_id, subject_id, rating1, rating2, rating3, rating4, rating5, rating6, rating7, rating8, rating9, rating10) 
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`
        pool.query(_query,
            [
                data.code,
